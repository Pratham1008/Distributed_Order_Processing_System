...
export default function Sidebar() {
    ...
    return (
        <nav className="bg-inverse-surface dark:bg-inverse-surface fixed left-0 top-0 h-screen w-[240px] flex flex-col overflow-y-auto shadow-md z-50 transition-transform duration-300 transform -translate-x-full md:translate-x-0" id="sidebar">
